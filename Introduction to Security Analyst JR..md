...
![[Pasted image 20220227194512.png]]
...
![](https://assets.tryhackme.com/additional/jrsecanalyst/task3.png)  
...
Nas notificações eu reparei que um dos logins realizou um ataque e conseguiu entrar no sistema:

```
221.181.185.159
```

A localização do ip era o seguinte:
